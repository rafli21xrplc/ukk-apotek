...
@section('content')
        ...
        <div class="d-flex justify-content-between align-items-center">
            ...
            <div class="d-flex justify-center gap-3 flex-row">
                <form class="d-flex justify-content-center gap-1 flex-row align-items-center mx-2"
                    action="{{ route('search.date.admin') }}" method="post">
                    @csrf
                    @method('POST')
                    <div class="mx-3">
                        Search Range
                ...
                <a href="{{ route('generate.admin') }}" class="btn btn-warning waves-effect waves-light text-white">Print
                </a>
            </div>
        </div>
    ...
    <div id="obat-modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="obat-modalLabel"
        ...
        <div class="modal-dialog">
            <form action="{{ route('tambah.transaksi.admin') }}" method="POST">
                @csrf
