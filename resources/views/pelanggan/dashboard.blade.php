...
@section('content')
                ...
                <tbody>
                    @forelse ($penjualan as $index => $item)
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                            ...
                            <td>
                                <form action="{{ route('generate.transaksi.pelanggan', $item->id_penjualan) }}"
                                    method="post">
                                    @csrf
                                    @method('POST')
                                    <button class="btn btn-warning text-white" type="submit">Print</button>
                                </form>
                            </td>
                        </tr>
                    @empty
    ...
    <div id="obat-modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="obat-modalLabel"
        ...
        <div class="modal-dialog">
            <form action="{{ route('tambah.transaksi.pelanggan') }}" method="POST">
                @csrf
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <input min="0" type="number" class="form-control" id="jumlah" name="jumlah"
